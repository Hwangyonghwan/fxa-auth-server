 ...
 * retrieve large payloads (~1MB) that persist for generous lengths of time
 * (~30 days).  We use it to provide a "command queue" for each connected
 * more reliable than its webpush subscription.
 *
 ...
 * It's like that we'll eventually refacor this out into a standalone
